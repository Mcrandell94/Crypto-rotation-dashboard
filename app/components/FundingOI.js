  ...
  return (
    <section style={{ marginTop: 32 }}>
      ...
      <p style={{ fontSize: 11, color: TEXT_MUTED, margin: '4px 0 16px' }}>
        ...
        Annualized = the hourly rate × 24 × 365: what holding the position for a year would cost
        (or earn) if today&apos;s rate never changed. It&apos;s a yardstick for how stretched positioning
        is, not a forecast — funding resets every hour.
      </p>
